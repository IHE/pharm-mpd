# Medication order - multiline (model) - Medication Prescription and Dispense (MPD) v1.0.0-comment-2
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/StructureDefinition/IHEMultilineOrder | *Version*:1.0.0-comment-2 |
| Active as of 2026-04-07 | *Computable Name*:IHEMultilineOrder |
