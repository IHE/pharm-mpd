...
| Active as of 2026-06-22 | *Computable Name*:IHEMedicationDispenseModel |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-IHEMedicationDispenseModel.json)
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        ...
        "https://profiles.ihe.net/PHARM/MPD/StructureDefinition/RelatedPersonBasic",
        "https://profiles.ihe.net/PHARM/MPD/StructureDefinition/PractitionerRoleBasic"]
      }]
    },
    {
      ...
      "type" : [{
        ...
        "https://profiles.ihe.net/PHARM/MPD/StructureDefinition/OrganizationBasic",
        "https://profiles.ihe.net/PHARM/MPD/StructureDefinition/DeviceBasic"]
      }]
    },
    {
