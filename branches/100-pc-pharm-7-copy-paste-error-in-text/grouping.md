# Single- and multiline prescriptions - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
1. **Multi-line Prescriptions**: A prescription can contain multiple lines.

This diagram shows the two models side by side, and their correspondence:

### Main Differences

|Element | In IHEMedicationOrderModel | In IHEMultilineOrder | Notes| |groupIdentifier | ✅ | ❌ | Present only in MedOrderModel| |status, medication, etc. | ✅ (at root) | ✅ (under medicationLine) | 1 order vs multiline| |indicationText | 0..* | 0..1 | cardinality difference| |medicationLine | ❌ | ✅ | multilevel structure in multiline|
