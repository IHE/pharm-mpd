...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Medication/f:ingredient">
      <sch:assert test="count(f:extension[@url = 'http://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medication-ingredient-role']) &lt;= 1">extension with URL = 'http://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medication-ingredient-role': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
</sch:schema>
