...
| | |
| :--- | :--- |
| [Device (model)](StructureDefinition-DeviceBasic.md) | Logical model for a device (basic data relevant for the IHE MPD use cases) |
...
| [Organization (model)](StructureDefinition-OrganizationBasic.md) | Logical model for an organization (basic data relevant for IHE MPD use cases) |
...
| [Practitioner role (model)](StructureDefinition-PractitionerRoleBasic.md) | Logical model for a practitioner role within an organization (basic data relevant for this use case) |
| [Related person (model)](StructureDefinition-RelatedPersonBasic.md) | Logical model for a related person with basic data relevant to the IHE MPD use cases. |
...
| [Medication - Ingredient role](StructureDefinition-ihe-ext-medication-ingredient-role.md) | Medication ingredient role - whether it is an active ingredient, excipient, adjuvant, solvent, flavouring, etc. |
