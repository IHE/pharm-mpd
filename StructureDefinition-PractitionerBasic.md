...
| Active as of 2026-06-22 | *Computable Name*:PractitionerBasic |
...
* Refer to this Logical Model: [Medication dispense (model)](StructureDefinition-IHEMedicationDispenseModel.md), [Medication order (model)](StructureDefinition-IHEMedicationOrderModel.md), [Medication order - multiline (model)](StructureDefinition-IHEMultilineOrder.md) and [Practitioner role (model)](StructureDefinition-PractitionerRoleBasic.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-PractitionerBasic.json)
