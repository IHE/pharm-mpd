...
| Active as of 2026-06-22 | *Computable Name*:DeviceBasic |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-DeviceBasic.json)
