# Medication - Device - Medication Prescription and Dispense (MPD) v1.0.0-comment-2
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medication-device | *Version*:1.0.0-comment-2 |
