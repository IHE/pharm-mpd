Instance: IHE.MPD.DispenseReceiver
InstanceOf: ActorDefinition
Usage: #definition
* url = "http://profiles.ihe.net/PHARM/MPD/ActorDefinition/IHE.MPD.DispenseReceiver"
...
* type = #system
* capabilities = Canonical(IHE.MPD.DispenseReceiverCS)
