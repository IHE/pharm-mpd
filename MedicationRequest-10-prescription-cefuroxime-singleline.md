# 10-prescription-cefuroxime-singleline - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
Tag: [Actionable (Details: Common Tags code actionable = 'Actionable')](http://terminology.hl7.org/7.2.0/CodeSystem-common-tags.html)
