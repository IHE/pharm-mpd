...
* refill number 0..1 string "refill number"
* date 0..1 dateTime "Date/Time of dispense" "Date/Time of dispense"
* location 0..1 sttring " " ""
* patient 1..1 Reference(Patient) "The person for which the medication is prescribed." "The person for which the medication is prescribed."
* expectedQuantity 0..1 number "Expected quantity (number of packs/number of units)" ""
* quantityDelivered 0..1 number "Quantity delivered (number of packs/number of units)" ""
* dispensing period 0..1 Period "Dispensing period (period for which the medication is dispensed)"
