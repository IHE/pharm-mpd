# IHE MPD Dispense Reporter Actor (server) - Medication Prescription and Dispense (MPD) v1.0.0-comment-2
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/CapabilityStatement/IHE.MPD.DispenseReporterCS | *Version*:1.0.0-comment-2 |
