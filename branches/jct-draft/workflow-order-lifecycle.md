# Order Lifecycle Management - Medication Prescription and Dispense (MPD) v1.0.0-comment-2
...
For general principles and context, see [Status and Workflow Management](status-workflow-management.md).
