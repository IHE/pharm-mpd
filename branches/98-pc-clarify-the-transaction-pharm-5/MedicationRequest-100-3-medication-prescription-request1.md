# 100-3-medication-prescription-request1 - Medication Prescription and Dispense (MPD) v1.0.0-comment-3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **100-3-medication-prescription-request1**

## Example MedicationRequest: 100-3-medication-prescription-request1
...
```json
{
  ...
  "id" : "100-3-medication-prescription-request1",
  "meta" : {
