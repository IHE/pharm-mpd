...
* marketingAuthorisationHolder 0..1 Base "Marketing authorisation holder of manufacturer of the medicinal product. Relevant for identifying the exact product."
...
* item 0..* Base "A medication item. For combination packs, this can be manufactured items with each item having its own dose form and ingredients+strengths defined"
  ...
  * ingredient 1..* Base "Ingredients"
    * role[x] 0..1 boolean or CodeableConcept "Role (active ingredient, excipient). Typically excipients are not needed, so by default active ingredients are expected."
    * substance 1..1 CodeableConcept "Substance"
    * strengthInfo 0..1 Base "Concentration or presentation strength"
