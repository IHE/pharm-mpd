# Medication - Ingredient role - Medication Prescription and Dispense (MPD) v1.0.0-comment-3

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Medication - Ingredient role**

## Extension: Medication - Ingredient role 
...
| Active as of 2026-06-22 | *Computable Name*:MedicationIngredientRole |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-ihe-ext-medication-ingredient-role.json)
...
```json
{
  ...
  "differential" : {
    "element" : [{
      "id" : "Extension",
      "path" : "Extension",
      "short" : "Medication - Ingredient role",
