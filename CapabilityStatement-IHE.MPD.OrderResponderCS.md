# IHE MPD Order Responder Actor (server) - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/CapabilityStatement/IHE.MPD.OrderResponderCS | *Version*:1.0.0-comment-3 |
