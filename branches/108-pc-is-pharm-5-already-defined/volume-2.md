# Volume 2 - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
* **PHARM-6:** [Submit Medication Order](pharm-6.md)
 Allows an Order Placer to submit a new or updated medication order.
* **PHARM-7:** [Retrieve Medication Order](pharm-7.md)
...
* **PHARM-9:** [Retrieve Medication Dispense](pharm-9.md)
