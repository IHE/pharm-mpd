# Use Cases and Patterns - Medication Prescription and Dispense (MPD) v1.0.0-comment-2
...
1. **Cancellation/change of the prescription**
 ...
 In some cases, the prescriber (or a co-author with the necessary rights) needs to change the order. Besides other tracking mechanisms that may apply, this is usually a simple change in the request.1.2. **By pharmacist or patient**
