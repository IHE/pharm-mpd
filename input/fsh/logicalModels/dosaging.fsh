...
* doseAndRate 0..* Class "Amount of medication administered per one dose (= one timing)"
  ...
  * dose 0..1 PQ or Range "Amount of medication per one dose. (1 tablet, 2-3 tablets, 20ml)"
  * rate 0..1 RTO or PQ or Range "Time period during which one defined dose is administered (per 1 hour, per 5-10 minutes)"
