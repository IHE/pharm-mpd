# Actor grouping examples - Medication Prescription and Dispense (MPD) v1.0.0-comment-3

* [**Table of Contents**](toc.md)
* **Actor grouping examples**

## Actor grouping examples

The actors illustrated the [actors and transactions](actors-transactions.md) can be grouped in different architectures.
