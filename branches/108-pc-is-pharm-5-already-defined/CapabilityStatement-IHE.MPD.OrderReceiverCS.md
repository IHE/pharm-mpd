# IHE MPD Order Receiver Actor (server) - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/CapabilityStatement/IHE.MPD.OrderReceiverCS | *Version*:1.0.0-comment-3 |
