# Medication - Classification - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medication-classification | *Version*:1.0.0-comment-3 |
| Active as of 2026-06-22 | *Computable Name*:MedicationClassification |
...
* Examples for this Extension: [Medication/01A-Cefuroxime1500GenericExplicit](Medication-01A-Cefuroxime1500GenericExplicit.md), [Medication/01C-Cefuroxime1500Branded](Medication-01C-Cefuroxime1500Branded.md), [Medication/01D-Cefuroxime750Branded](Medication-01D-Cefuroxime750Branded.md), [Medication/02A-ClotrimazoleCanifugCremolum](Medication-02A-ClotrimazoleCanifugCremolum.md)... Show 2 more, [Medication/03B-VitaminBComplexBranded](Medication-03B-VitaminBComplexBranded.md) and [Medication/04-FirmagonBranded](Medication-04-FirmagonBranded.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-ihe-ext-medication-classification.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Extension.url",
      "path" : "Extension.url",
      "fixedUri" : "https://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medication-classification"
    },
    {
