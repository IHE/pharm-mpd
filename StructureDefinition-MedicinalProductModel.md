...
| Active as of 2026-06-22 | *Computable Name*:MedicinalProductModel |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-MedicinalProductModel.json)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      {
        "code" : "Reference",
        "targetProfile" : ["https://profiles.ihe.net/PHARM/MPD/StructureDefinition/DeviceBasic"]
      }]
    },
    {
