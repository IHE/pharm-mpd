...
| Active as of 2026-04-22 | *Computable Name*:MedicationClassification |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ihe.pharm.mpd|current/StructureDefinition/ihe-ext-medication-classification)
