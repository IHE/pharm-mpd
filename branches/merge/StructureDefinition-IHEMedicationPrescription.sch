...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationRequest">
      <sch:assert test="count(f:extension[@url = 'http://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medicationrequest-offlabeluse']) &lt;= 1">extension with URL = 'http://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medicationrequest-offlabeluse': maximum cardinality of 'extension' is 1</sch:assert>
