# Patient (model) - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/StructureDefinition/PatientBasic | *Version*:1.0.0-comment-3 |
| Active as of 2026-06-22 | *Computable Name*:PatientBasic |
...
* Refer to this Logical Model: [Medication dispense (model)](StructureDefinition-IHEMedicationDispenseModel.md), [Medication order (model)](StructureDefinition-IHEMedicationOrderModel.md), [Medication order - multiline (model)](StructureDefinition-IHEMultilineOrder.md) and [Related person (model)](StructureDefinition-RelatedPersonBasic.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-PatientBasic.json)
