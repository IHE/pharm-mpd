# MedicationRequest - Prescribed Quantity - Medication Prescription and Dispense (MPD) v1.0.0-comment-3
...
| | |
| :--- | :--- |
| *Official URL*:https://profiles.ihe.net/PHARM/MPD/StructureDefinition/ihe-ext-medicationrequest-prescribedQuantity | *Version*:1.0.0-comment-3 |
| Active as of 2026-06-22 | *Computable Name*:MedicationRequestPrescribedQuantity |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ihe.pharm.mpd|current/StructureDefinition/StructureDefinition-ihe-ext-medicationrequest-prescribedQuantity.json)
