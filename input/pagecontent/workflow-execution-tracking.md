...
This page details the patterns for tracking the execution and fulfillment of medication orders using Task. For general principles, see [Status and Workflow Management](status-workflow-management.html).
